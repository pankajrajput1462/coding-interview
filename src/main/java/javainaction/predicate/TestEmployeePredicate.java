...
import static javainaction.predicate.EmployeePredicates.*;
...
public class TestEmployeePredicate {
    public static void main(String[] args) {    
        ...
        System.out.println(filterEmployee(employees, isAgeMore(35)));

        //Employees other than above collection of "isAgeMoreThan(35)" can be get using negate()
        System.out.println(filterEmployee(employees, isAgeMore(35).negate()));
    }
}
